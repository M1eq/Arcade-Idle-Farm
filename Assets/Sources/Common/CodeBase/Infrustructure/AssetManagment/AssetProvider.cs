...
public class AssetProvider : IAssetProvider
{
    ...
    {
        if (_completedCache.TryGetValue(dataPrefabReference.AssetGUID, out AsyncOperationHandle completedHandle))
    ...
    public async UniTask<List<T>> LoadAssetList<T>(string label) where T : class
    {
